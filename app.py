...
<style>
    ...
    * {
    ...
    .netflix-gradient-text {
        background: linear-gradient(135deg, #E50914 0%, #B81D24 50%, #8B0000 100%);
    ...
    .recommendation-card::after {
        ...
        width: 100px;
        height: 100px;
        background: linear-gradient(135deg, transparent 50%, rgba(229, 9, 20, 0.1) 50%);
    ...
    .floating-icon {
        animation: netflix-pulse 3s infinite ease-in-out;
    }
...
def display_metric_card(title: str, value: str, subtitle: str = "", icon: str = "📊"):
    ...
    <div class="metric-card">
        <div style="font-size: 3.5rem; margin-bottom: 1rem; color: #E50914;" class="floating-icon">{icon}</div>
        <h3 class="netflix-gradient-text">{value}</h3>
...
<div class="main-header">
    <div style="display: flex; align-items: center; gap: 2rem; margin-bottom: 2rem; position: relative; z-index: 2;">
        <div style="font-size: 5rem;" class="floating-icon">🎬</div>
        <div>
            <h1 class="netflix-gradient-text">NETFLIX RECOMMENDER</h1>
            <p style="margin: 0; font-size: 1.5rem; font-weight: 600;">Sistem Rekomendasi Berbasis Machine Learning</p>
        </div>
    </div>
...
with st.sidebar:
    ...
    <div style="text-align: center; margin-bottom: 2.5rem; padding: 2.5rem 1.5rem;
                ...
                border-radius: 12px; border: 2px solid #E50914; backdrop-filter: blur(10px);">
        <div style="font-size: 4rem; color: #E50914; margin-bottom: 1rem;" class="floating-icon">🎬</div>
...
# -----------------------------
# Page: Recommendation - Netflix Style
# -----------------------------
if page == "🎯 REKOMENDASI":
...
# -----------------------------
# Page: Data Analysis - Netflix Style
# -----------------------------
...
# -----------------------------
# Page: About System - Netflix Style
# -----------------------------
    ...
    <div style="text-align: center; padding: 3rem; border-radius: 12px; border: 2px solid #E50914;
        ...
        <div style="font-size: 4rem; color: #E50914;" class="floating-icon">🎬</div>
